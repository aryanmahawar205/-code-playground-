...
// the graph is an directed and unweighted graph
...
int main()
{
    ...
    int u, v; // these will be the variables showing edge relationship (like u=0 & v=1 means between vertices 0 and 1, there is an edge)
