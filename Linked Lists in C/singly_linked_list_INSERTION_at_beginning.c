...
int main()
{
    ...
    // Print the linked list data before
    printf("\nLinked List data before insertion at beginning: ");
    temp = head;
    while (temp != NULL)
    {
        printf("%d ", temp->data);
    ...
    struct node *newNodeBeginning;
    newNodeBeginning = (struct node*)malloc(sizeof(struct node));
    printf("\nEnter the data you wish to insert in the beginning - ");
    scanf("%d", &newNodeBeginning->data);
    newNodeBeginning->next = head;
    head = newNodeBeginning;

    // Print the linked list data after
    printf("\nLinked List data after insertion at beginning: ");
    temp = head;
    while (temp != NULL)
    {
        printf("%d ", temp->data);
