...
int main()
{
    ...
    // Print the linked list data before deletion from the beginning
    printf("\nLinked List data before deletion from the beginning: ");
    temp = head;
    while (temp != NULL)
    {
        printf("%d ", temp->data);
    ...
    if (head == NULL)
        printf("Linked list empty, cannot delete!");
    ...
    // Print the linked list data after deletion from the beginning
    printf("\nLinked List data after deletion from the beginning: ");
    temp = head;
    while (temp != NULL)
    {
        printf("%d ", temp->data);
